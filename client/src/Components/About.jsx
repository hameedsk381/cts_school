...
"
        ...
        <Typography variant='h4' textTransform={'uppercase'} color='Highlight' align='center' >The school emblem and the motto</Typography>
        <Stack spacing={1} p={4}>
        <Typography align="justify">The School emblem consists of Sacred Heart and the crown with the cross is designed with the School motto "Reach out in Love" inscribed beneath.
        </Typography>
        ...
        <Typography align="justify">The emblem and motto graphically portray the thrust of the School to mould young minds and hearts and help them blossom into knowledgeable and virtuous young men and
